...
__global__ void power_microbench(float *data1, float *data2, uint32_t *data3, uint32_t *data4, float *res, int div, unsigned long long iterations, half *a, half *b, float *c, int M, int N, int K) {
