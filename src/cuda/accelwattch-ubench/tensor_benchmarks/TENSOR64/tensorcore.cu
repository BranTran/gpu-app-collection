...
//   cudaErrCheck(cudaMalloc((void**)&b_fp16, MATRIX_K * MATRIX_N * sizeof(half)));
   ...
   cudaErrCheck(cudaMalloc((void**)&c, MATRIX_M * MATRIX_N * sizeof(double)));
   ...
   double *c_h = (double*) malloc(MATRIX_M * MATRIX_N*sizeof(double));
   RandomInit_fp(a_fp64_h, MATRIX_M * MATRIX_K);
   RandomInit_fp(b_fp64_h, MATRIX_K * MATRIX_N);
   RandomInit_fp( c_h, MATRIX_M * MATRIX_N);
   cudaErrCheck(cudaMemcpy(c, c_h, MATRIX_M * MATRIX_N * sizeof(double), cudaMemcpyHostToDevice));
...
//   convertFp32ToFp16 <<< (MATRIX_K * MATRIX_N + 255) / 256, 256 >>> (b_fp16, b_fp32, MATRIX_K * MATRIX_N);
   ...
   cudaErrCheck(cudaMemcpy(c_wmma, c, MATRIX_M * MATRIX_N * sizeof(double), cudaMemcpyDeviceToDevice));
